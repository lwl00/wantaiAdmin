...
import { getDictsData, getIntegralGift, getGiftType, getGiftClass, editGifeChange, addRulesAPPOINTAction, isGiftCode } from 'api/interface';
export default {
    components: {
        Table,
        Search,
    ...
    methods: {
        ...
        _getDictsData: function () {
            ...
            getDictsData(paramsGiftType).then(res => {
                this.searchOptions.filter(item => item.field === 'giftTypeCode')[0].options = res.data
            })
            ...
            getGiftClass(categoryParams).then(res => {
                // 新增两字段   
                ...
                this.searchOptions.filter(item => item.field === 'category')[0].options = res.data
            })
        ...
        getPermissions: function () {
            ...
            tableBtnPermissions(this.table.title, 'update', permissionsBtnArr.includes("gift:pointGift:update"))
        },
        //获取列表
        _getIntegralGift: function (pageNum, pageSize) {
            let params = {
                companyCode: this.search.companyCode,
                category: this.search.category,
                giftTypeCode: this.search.giftTypeCode,
