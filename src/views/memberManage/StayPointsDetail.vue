...
import { formatDateSearch, formatDateTimes, dateToStamp, deleteBlankSpace, onlineDateTime, todayEndTime, calculateTableHeight, formatSearch } from 'common/js/dom';
